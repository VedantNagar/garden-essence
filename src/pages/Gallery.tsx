  ...
  const videos = [
    {
      ...
      description: "Learn how to set up your first hydroponic system from scratch using our premium nutrients.",
    ...
    },
    {
      ...
      description: "See the amazing results when comparing our Growth Formula with traditional growing methods.",
      thumbnail: "https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg",
      duration: "8:45",
      category: "Comparison"
    },
    {
      ...
      description: "Real customers share their incredible results using our Advanced Root Booster formula.",
      thumbnail: "https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg",
      duration: "12:15",
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Discover the power of our hydroponic nutrients through videos, testimonials, 
            and success stories from growers around the world.
          </p>
        </div>
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {videos.map((video) => (
              <Card key={video.id} className="group hover:shadow-forest transition-all duration-300 hover:-translate-y-2 overflow-hidden">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="group relative overflow-hidden rounded-lg bg-card hover:shadow-forest transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="bg-gradient-nature rounded-lg p-8 md:p-12 text-center text-primary-foreground shadow-forest">
          ...
          <p className="text-lg opacity-95 mb-8 max-w-2xl mx-auto">
            Join thousands of successful growers who have transformed their gardens 
            with our premium hydroponic nutrients. Your plants deserve the best.
          </p>
